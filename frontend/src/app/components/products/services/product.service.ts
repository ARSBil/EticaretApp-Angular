...
export class ProductService {
  ...
  getAllForHomePage(model: RequestModel, callBack: (res: PaginationResultModel<ProductModel[]>) => void) {
    this._http.post<PaginationResultModel<ProductModel[]>>("products/getAllForHomePage", model, res => callBack(res));
  }
}
